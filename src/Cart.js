function Cart() {
	return (
		<div className="p-12 bg-white rounded-xl sm:mx-auto sm:max-w-2xl">
			<p className="text-[#ca5531] font-bold text-3xl">Your Cart (0)</p>
			<div className="flex flex-col items-center mt-9">
				...
				<p className="mt-4 mb-5 text-lg font-semibold text-gray-500">
